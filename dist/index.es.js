...
function defaultPhrases() {
  return Object.keys(defaultPhrases).reduce(function (phrases, key) {
    return _objectSpread$7(_objectSpread$7({}, phrases), {}, defineProperty({}, key, PropTypes.oneOfType([PropTypes.string, PropTypes.func, PropTypes.node])));
  }, {});
}
...
var galleryPropTypes = forbidExtraProps({
  ...
  wrap: PropTypes.bool,
  phrases: PropTypes.shape(defaultPhrases()),
...
var propTypes$a = forbidExtraProps(_objectSpread$6(_objectSpread$6({}, imagePropTypes), {}, {
...
var propTypes$9 = forbidExtraProps(_objectSpread$5(_objectSpread$5({}, imagePropTypes), {}, {
  photo: PhotoShape,
...
var propTypes$1 = forbidExtraProps({
  onPress: PropTypes.func,
  light: PropTypes.bool
});
var defaultProps$1 = {
...
var propTypes = forbidExtraProps(_objectSpread(_objectSpread({}, galleryPropTypes), {}, {
